    ...
    methods: {
      searchTexts: function searchTexts() {
        ...
        if (this.textInput.length > 2) {
          axios.get(this.autocompleteUrl + this.textInput).then(function (response) {
