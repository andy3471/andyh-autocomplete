(function (global, factory) {
  ...
  (global = global || self, factory(global.AndyHAutoComplete = {}, global.axios));
    ...
    methods: {
      searchTexts: function searchTexts() {
        ...
        if (this.textInput.length > 2) {
          ...
          setTimeout(function () { 
            if (search == this$1.textInput) {
              this$1.isHolding = false;

              axios.get(this$1.url + this$1.textInput).then(function (response) {
  ...
  var __vue_render__ = function() {
    ...
    return _c("div", { staticClass: "autocomplete", style: _vm.cssVars }, [
      _c("input", {
        directives: [
          {
            name: "model",
